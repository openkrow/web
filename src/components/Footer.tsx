...
const footerLinks = {
  ...
  Company: [
    ...
    { label: "Support", href: "https://discord.gg/openkrow" },
  ],
  Socials: [
    { label: "GitHub", href: "https://github.com/openkrow/openkrow" },
    { label: "Discord", href: "https://discord.gg/openkrow" },
    { label: "Twitter/X", href: "https://x.com/openkrow" },
  ],
};

export function Footer() {
  return (
    <footer className="bg-[#0A0A0A] grid-background-dark">
      <div className="max-w-[1200px] mx-auto px-6 py-16">
        ...
        <div className="mt-12 pt-8 border-t border-[#333] flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-[#94A3B8]">
            Copyright &copy; {new Date().getFullYear()} OpenKrow Contributors.
          </p>
          <div className="flex items-center gap-4">
            <a href="https://github.com/openkrow/openkrow" target="_blank" rel="noopener noreferrer" className="text-[#94A3B8] hover:text-white transition-colors">
            ...
            <a href="https://discord.gg/openkrow" target="_blank" rel="noopener noreferrer" className="text-[#94A3B8] hover:text-white transition-colors">
            ...
            <a href="https://x.com/openkrow" target="_blank" rel="noopener noreferrer" className="text-[#94A3B8] hover:text-white transition-colors">
